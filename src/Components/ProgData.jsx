...
const ProgData = ({ progDataPromise }) => {
        ...
        return (
            ...
            <div className= "m-4 p-4 bg-gray-100 rounded shadow"> 
                ...
                <div className="w-3/4 grid grid-cols-3  gap-4 m-4 p-4 bg-gray-100 rounded shadow">
                    <div>
                        <div key={t.id} className="bg-white p-4 rounded shadow">
                            ...
                            <div className="grid grid-cols-3 gap-2 mt-2">
                                <span className="badge badge-xs badge-warning">{t.category}</span>
                                <span className="badge badge-xs badge-warning">{t.difficulty}</span>
                                <span className="badge badge-xs badge-warning">{t.rating}</span>
                            </div>

                            <div>
                                <div className="mt-2">
                                <button className="btn btn-sm btn-block bg-black text-white">Add to Stack</button>
                                </div>
                            </div>
                        </div>                           
